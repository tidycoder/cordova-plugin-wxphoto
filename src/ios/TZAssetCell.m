...
- (void)setModel:(TZAssetModel *)model {
    _model = model;
    [[TZImageManager manager] getPhotoWithAsset:model.asset photoWidth:self.width clampAtRatio:0.5f completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
